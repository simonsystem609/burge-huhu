...
(function () {
  ...
  const STR = {
    hu: {
      ...
      defendPrompt: 'Húzz egy lapot az ütendőre, vagy húzd a lapot magadhoz, ha felveszed',
      take: 'Felveszem',
      attackBtn: 'Küldés',
      swap7: 'Adu VII csere',
    ...
    en: {
      ...
      defendPrompt: 'Drag a card onto the one you want to beat, or drag a card to yourself to pick it up',
      take: 'Pick up',
      attackBtn: 'Send',
