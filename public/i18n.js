...
(function () {
  ...
  const STR = {
    hu: {
      ...
      matchmake: 'Ellenfél keresése',
      peopleLooking: '(Keresők: {count})',
      searching: 'Ellenfél keresése…',
      searchingHint: 'Várakozás másik játékosra…',
      cancel: 'Mégse',
      yourName: 'Neved',
      ...
      defendPrompt: 'Tedd rá a lapjaid, amit le akarsz ütni, majd Ütés — a többit felveszed',
      take: 'Felveszem',
      attackBtn: 'Küldés',
      beatBtn: 'Ütés',
      swap7: 'Adu VII csere',
      ...
      err_session_auth_failed: 'A m\u00e1sik munkamenet igazol\u00e1sa sikertelen. Friss\u00edtsd az oldalt, majd pr\u00f3b\u00e1ld \u00fajra.',
    ...
    en: {
      ...
      matchmake: 'Find match',
      peopleLooking: '(People looking: {count})',
      searching: 'Finding an opponent…',
      searchingHint: 'Waiting for another player…',
      cancel: 'Cancel',
      yourName: 'Your name',
      ...
      defendPrompt: 'Place cards on what you want to beat, then press Beat — the rest is picked up',
      beatBtn: 'Beat',
      take: 'Pick up',
      attackBtn: 'Send',
      ...
      err_session_auth_failed: 'Could not verify the other session. Refresh the page and try again.',
